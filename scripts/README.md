...
- `stability-24h-driver.py` — drives the 24-hour orchestrator stability
  rehearsal (Phase 4 DEPLOY-02 evidence harness). Hardware-agnostic; the
  reference run was executed against a Raspberry Pi orchestrator.
